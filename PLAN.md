...
* EEST checks use `tools/eest-baseline.py` to preserve passed fixtures and ratchet allowed failure codes;
  refresh `tools/eest-baseline.json` only with the reviewed `update` command.
